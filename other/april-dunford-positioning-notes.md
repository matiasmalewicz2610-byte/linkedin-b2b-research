# Positioning as Content Strategy Foundation — April Dunford
**Source:** aprildunford.com / "Obviously Awesome" (2019) / "Sales Pitch" (2023) / Podcast: Positioning with April Dunford
**YouTube:** https://youtube.com/@positioningshow
**Why this matters:** Positioning is the answer to "what do we say?" — which must be answered before "how do we say it on LinkedIn?" Content without positioning generates followers. Content with positioning generates pipeline. This is the strategic layer that the other 9 experts assume but never teach.

---

## The 5-component positioning framework (from "Obviously Awesome")

### Component 1: Competitive alternatives
What would your customers do if you didn't exist?
...
The positioning exercise answers three LinkedIn content questions:

| Positioning question | LinkedIn content implication |
|---------------------|------------------------------|
| Who are our competitive alternatives? | Defines what "before you" looked like — great for contrast content |
| What are our unique attributes? | Defines your content angles — what only you can credibly post |
| What value do we deliver? | Defines the outcomes your content should promise and demonstrate |
...
- Justin Welsh's ICP-first content approach is the LinkedIn execution of April's "target customer" component
- Devin Reed's "Build vs. Optimize" framework starts after positioning — April covers what comes before
